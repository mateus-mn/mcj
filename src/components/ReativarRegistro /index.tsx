...
const ReativarRegistro = ({id, modulo, refetch, statusReativarRegistro, setStatusReativarRegistro} : ReativarRegistroProps) =>
{
	...
	return (
		<>
			...
			>	
				...
				<Modal.Footer>
					<button className="btn btn-danger" onClick={reativar} disabled={isLoading}> Sim </button>
					<button className="btn btn-primary" onClick={() => setStatusReativarRegistro(false)} disabled={isLoading}> Não </button>
				</Modal.Footer>
			</Modal>
		</>
	);
