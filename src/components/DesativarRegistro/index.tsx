...
const DesativarRegistro = ({id, modulo, refetch, statusDesativarRegistro, setStatusDesativarRegistro} : DesativarRegistroProps) =>
{
	...
	return (
		<>
			...
			>	
				...
				<Modal.Footer>
					<button className="btn btn-danger" onClick={desativar} disabled={isLoading}> Sim </button>
					<button className="btn btn-primary" onClick={() => setStatusDesativarRegistro(false)} disabled={isLoading}> Não </button>
				</Modal.Footer>
			</Modal>
		</>
	);
