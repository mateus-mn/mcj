...
const LoginPage = () =>
{
	...
	const validacaoFormulario = yup.object({
		login : yup.string ().required ("Usuário em branco").min (3, "O usuário deve possuir ao menos três caracteres"),
		senha : yup.string ().required ("Senha em branco").min (3, "A senha deve possuir ao menos três caracteres")
	}).required ();
		...
		<div className="container mt-3">
			<div className="row">
				...
				<form noValidate onSubmit={handleSubmit(logar)}>
					<div className="row mt-3">
						<div className="col-5 offset-1">
							<div className="form-group">
								<label htmlFor="login"> Login <FontAwesomeIcon icon={faAsterisk} /> </label>
								<input
									{...register ("login")}
						...
						<div className="col-5">
							<div className="form-group">
								<label htmlFor="senha"> Senha <FontAwesomeIcon icon={faAsterisk} /> </label>
								<input
									{...register ("senha")}
									type="password"
					...
					<div className="row mt-3">
						<div className="col-11 offset-1">
							<button type="submit" className="btn btn-success mt-3" disabled={isLoading}> Login </button>
						</div>
					</div>
				</form>							
			</div>
